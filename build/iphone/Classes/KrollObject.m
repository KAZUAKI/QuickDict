...
//@interface QuickDicObject : NSObject
//@end

@interface QuickDicObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[QuickDicObject class]])
		{
			for (NSString *key in [[(QuickDicObject*)o modules] allKeys])
			{
