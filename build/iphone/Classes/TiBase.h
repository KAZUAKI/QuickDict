...
// in simulator we redefine to format for QuickDic Developer console
...
{\
	NSString * exceptionName = [@"org.quickdic." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.quickdic";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIQuickDicNativeItemNone = -1, 
	UIQuickDicNativeItemSpinner = -2,
	UIQuickDicNativeItemProgressBar = -3,
	
	UIQuickDicNativeItemSlider = -4,
	UIQuickDicNativeItemSwitch = -5,
	UIQuickDicNativeItemMultiButton = -6,
	UIQuickDicNativeItemSegmented = -7,
	
	UIQuickDicNativeItemTextView = -8,
	UIQuickDicNativeItemTextField = -9,
	UIQuickDicNativeItemSearchBar = -10,
	
	UIQuickDicNativeItemPicker = -11,
	UIQuickDicNativeItemDatePicker = -12,
	
	UIQuickDicNativeItemInfoLight = -13,
	UIQuickDicNativeItemInfoDark = -14,
	
	UIQuickDicNativeItemDisclosure = -15,
	
	UIQuickDicNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all QuickDic instances of
