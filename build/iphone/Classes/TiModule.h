...
/**
 The base class for all QuickDic modules
 */
...
/**
 QuickDic Platform calls this method on startup.
 */
-(void)startup;

/**
 QuickDic Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 QuickDic Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 QuickDic Platform calls this method on resume.
 @param sender The sender of the event.
 */
